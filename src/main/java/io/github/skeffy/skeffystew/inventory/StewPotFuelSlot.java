...
public class StewPotFuelSlot extends SlotItemHandler {
    private final StewPotMenu menu;

    public StewPotFuelSlot(StewPotMenu menu, IItemHandler itemHandler, int index, int xPosition, int yPosition) {
